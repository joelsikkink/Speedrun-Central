...
class RobloxSpeedrun4Forums extends React.Component {
  ...
  renderPage() {
    return (
        <Container>
          <Header as="h2" textAlign="center">Roblox Forums</Header>
...
RobloxSpeedrun4Forums.propTypes = {
...
export default withTracker(() => {
  ...
  return {
    forums: Forums.find({game: 'Roblox: Speed Run 4'}).fetch(),
    ready: subscription.ready(),
  };
})(RobloxSpeedrun4Forums);