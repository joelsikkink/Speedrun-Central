...
class SuperMario64Forums extends React.Component {
  ...
  renderPage() {
    return (
        <Container>
          <Header as="h2" textAlign="center">Super Mario 64 Forums</Header>
...
export default withTracker(() => {
  ...
  return {
    forums: Forums.find({game: 'Super Mario 64'}).fetch(),
